...
import { MdSize, Orientation, Justify, Align, PX, Gap } from '@/components/enum';
  ...
  return (
    <SectionMain gap={Gap['80px']} px={PX['32px']}>
      ...
      <Container align={Align.center} gap={Gap['32px']}>
        <ContainerChild mdSize={MdSize.w6v12} justify={Justify.center} orientation={Orientation.mdCol} gap={Gap['16px']}>
