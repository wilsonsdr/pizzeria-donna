  ...
  return (
    <div className='flex flex-col gap-8'>
      <Container gap={Gap['32px']} align={Align.start}>
        <ContainerChild gap={Gap['16px']} mdSize={MdSize.w6v12} orientation={Orientation.mdCol}>
          <List text='Fit' price='51,00' ingredients='Frango desfiado, ovos, brócolos, cebola roxa, palmido e azeitona preta' />
        </ContainerChild>
        <ContainerChild gap={Gap['16px']} mdSize={MdSize.w6v12} orientation={Orientation.mdCol} justify={Justify.left}>
